...
function InfoBlock() {
  return (
    <div>
      <ul className="info-list d-flex m-5 justify-content-around align-items-center text-center">
        <li className="info-item border-end border-3">
        ...
        <li className="info-item border-end border-3">
          ...
          <img src="./iconos/transporter.svg" alt="" />
        </li>
        <li className="info-item border-end border-3">
